...
First Run:
    ...
    Choose input and output audio devices.
    Choose Push-to-Talk key. Default is F12.
    Use Static Test Room for initial testing, or Journal Mode for Elite Dangerous.
    Click Connect.
